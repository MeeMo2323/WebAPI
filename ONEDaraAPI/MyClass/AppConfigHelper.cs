...
namespace ONEDaraAPI.MyClass
{
    public class AppConfigHelper
    {
        ...
        public string DaraTokenPeriod;
        public string DaraTokenValue;


        public string EncryptionKey = System.Configuration.ConfigurationManager.AppSettings.Get("ApplicationSecret");
        ...
        public void ReadAppconfig()
        {
            ...
            DaraTokenPeriod = System.Configuration.ConfigurationManager.AppSettings.Get("DaraTokenPeriod");
            DaraTokenValue = System.Configuration.ConfigurationManager.AppSettings.Get("DaraTokenValue");
        ...
        public string passwordDecrypt(string cryptTxt, string key)
        {
            ...
            using (Aes aes = Aes.Create())
            {
                ...
                using (MemoryStream mStream = new MemoryStream())
                {
                    ...
                    //cryptTxt = Convert.ToBase64String(mStream.ToArray());
                }
            }
            return cryptTxt;
        }
